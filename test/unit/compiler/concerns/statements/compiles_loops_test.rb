...
class CompilesLoopsTest < TestCase
  def test_while
    assert_compiles_to "@ruby(i = 0) @while(i < 5) {{ i += 1 }} @endwhile",
      "i = 0;while i < 5;@output_buffer.append=i += 1;end;",
      "12345"
  end

  def test_for
    assert_compiles_to "@for(i in 1..5) {{ i }} @endfor",
      "for i in 1..5;@output_buffer.append=i;end;",
      "12345"
  end

  def test_until
    assert_compiles_to "@ruby(i = 0) @until(i == 5) {{ i += 1 }} @endwhile",
      "i = 0;until i == 5;@output_buffer.append=i += 1;end;",
      "12345"
  end
  ...
  def test_break
    ...
    assert_compiles_to "@ruby(i = 0) @while(true) @if(i == 5) @break @endif {{ i += 1 }} @endwhile",
      "i = 0;while true;if i == 5;break;end;@output_buffer.append=i += 1;end;",
      "12345"
  ...
  def test_next
    ...
    assert_compiles_to "@ruby(i = 0) @while(i < 5) @ruby(i += 1) @if(i == 3) @next @endif {{ i }} @endwhile",
      "i = 0;while i < 5;i += 1;if i == 3;next;end;@output_buffer.append=i;end;",
      "1245"
  ...
  def test_each
    assert_compiles_to "@each(a in [1, 2, 3]) {{ a }} @endEach",
      "[1, 2, 3].each do |a|;@output_buffer.append=a;end;",
      "123"

    assert_compiles_to "@each(a, b in {a:1, b:2, c:3}) {{ a }}{{ b }} @endEach",
      "{a:1, b:2, c:3}.each do |a,b|;@output_buffer.append=a;@output_buffer.append=b;end;",
      "a1b2c3"
  end
  ...
  def test_eachwithindex
    assert_compiles_to "@eachWithIndex(a in ['a', 'b', 'c']) {{ a }} @endEachWithIndex",
      "['a', 'b', 'c'].each_with_index do |a|;@output_buffer.append=a;end;",
      "abc"

    assert_compiles_to "@eachWithIndex(a, b in ['a', 'b', 'c']) {{ a }}{{ b }} @endEachWithIndex",
      "['a', 'b', 'c'].each_with_index do |a,b|;@output_buffer.append=a;@output_buffer.append=b;end;",
      "a0b1c2"

    assert_compiles_to "@eachWithIndex(a in {a:1, b:2, c:3}) {{ a }} @endEachWithIndex",
      "{a:1, b:2, c:3}.each_with_index do |a|;@output_buffer.append=a;end;",
      "[:a, 1][:b, 2][:c, 3]"

    assert_compiles_to "@eachWithIndex(a, b in {a:1, b:2, c:3}) {{ a }}{{ b }} @endEachWithIndex",
      "{a:1, b:2, c:3}.each_with_index do |a,b|;@output_buffer.append=a;@output_buffer.append=b;end;",
      "[:a, 1]0[:b, 2]1[:c, 3]2"

    assert_compiles_to "@eachWithIndex(a, b, c in {a:1, b:2, c:3}) {{ a }}{{ b }}{{ c }} @endEachWithIndex",
      "{a:1, b:2, c:3}.each_with_index do |_ivar,c|;a,b=_ivar;@output_buffer.append=a;@output_buffer.append=b;@output_buffer.append=c;end;",
      "a10b21c32"
  end
